#!/usr/bin/env python3
"""Add data-i18n attributes to HTML elements for translation"""
...
content = content.replace('>Пройти самообследование<', ' data-i18n="self_exam_video">Пройти самообследование<')
...
content = content.replace('>XP<', ' data-i18n="card_progress">XP<')
...
content = content.replace('>Снизить смертность от рака молочной железы за счёт раннего выявления, цифрового мониторинга здоровья и доступной профилактики.<', ' data-i18n="mission_desc">Снизить смертность от рака молочной железы за счёт раннего выявления, цифрового мониторинга здоровья и доступной профилактики.<')
...
print("data-i18n attributes added! Count:", content.count('data-i18n='))
